"""
**CODE FROM Erin Sheldon: https://github.com/esheldon/kmeans_radec**
...
def kmeans_sample(X, ncen, nsample=None, maxiter=_MAXITER_DEF, seed=100, **kw ):
    """
    ...
    Xsample = random_sample( X, int(nsample), seed )

    # choose random sample as centers
    pass1centers = random_sample( X, int(ncen), seed )
